...
class PlatformManager {
    ...
    start() {
        ...
        this.intercomServer = new pmng.Intercom.Server();
        this.intercomServer.start();

        // start process stats
        pmng.ProcessStats.pidId("main_process");

        // starting subprocesses responder to centralize commands/timeouts
        pmng.SubprocessUtils.responder();
        pmng.SubprocessUtils.forkNamed("./pmng_server/root_commands", "root_commands", "root commands processor");
        ...
        pmng.SubprocessUtils.forkNamed("./pmng_server/ftp_server/ftp_server", "ftp_server", "FTP server");
        ...
        pmng.SubprocessUtils.forkNamed("./pmng_server/local_server/local_main", "local_server", "local server");
...
if(module === require.main) {
    const platform_manager = new PlatformManager();
    platform_manager.start();
} else {
